" Maintainer: David Billskog <billskog@gmail.com.com>
...
hi TabLine     guifg=#000000 gui=reverse
hi TabLineSel  guifg=bg      guibg=fg
hi TabLineFill guifg=#000000 guibg=#000000
hi TabLine     guifg=#303030 gui=reverse
hi TabLineSel  guifg=bg      guibg=fg
...
hi NonText guifg=#404040 guibg=#141414
hi SpecialKey guifg=#404040 guibg=#202020

"Hihlight the window you are in instead of highlighting the windows you arent
hi StatusLine term=bold,reverse cterm=bold,reverse gui=bold,reverse guifg=#7587A6 guibg=#F8F8F8
hi StatusLineNC term=reverse cterm=reverse gui=reverse guifg=#0E2231 guibg=#8693A5

hi LineNr guifg=#303030 guibg=#000000
